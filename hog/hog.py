...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0,score1):
        ...
        if gain > previous_high:
            print("%d point(s)! That's the biggest gain yet for Player %d" % (gain,who))
            pre_high = gain
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_roll <= 10:
        ...
        if averaged_dice(num_roll,dice) > max_roll:
            max_roll_num = num_roll
            max_roll = averaged_dice(num_roll,dice)
        num_roll += 1
    return max_roll_num   
