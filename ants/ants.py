...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.is_truequeen = not self.queen_count
    ...
    def action(self, colony):
        ...
        if self.is_truequeen:
            ...
            while next_place:
                ...
                if next_ant:
                    if hasattr(next_ant,'damage') and not next_ant.is_buffed:
                        next_ant.damage = next_ant.damage * 2
                        next_ant.is_buffed = True
                    if next_ant.is_container and next_ant.contained_ant and \
                    hasattr(next_ant.contained_ant,'damage') and not next_ant.contained_ant.is_buffed:
                        next_ant.contained_ant.damage = next_ant.contained_ant.damage * 2
                        next_ant.contained_ant.is_buffed = True
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self, hive):
        ...
        while place != hive:
            if place.ant:
                results[place.ant] = distance
                if place.ant.is_container and place.ant.contained_ant:
                    results[place.ant.contained_ant] = distance
            for bee in place.bees:
                results[bee] = distance
