...
def check_win_row(board, max_rows, max_cols, num_connect, row, player):
    ...
    for i in range(max_cols-num_connect+1):
        lst = [get_piece(board,row,j) == player for j in range(i,i+num_connect)]
        if False not in lst:
            return True
    return False
...
def check_win_column(board, max_rows, max_cols, num_connect, col, player):
    ...
    for i in range(max_rows-num_connect+1):
        lst = [get_piece(board,j,col) == player for j in range(i,i+num_connect)]
        if False not in lst:
            return True
    return False
...
def check_win(board, max_rows, max_cols, num_connect, row, col, player):
    ...
    return True in [diagonal_win,column_win,row_win]
###############################################################
